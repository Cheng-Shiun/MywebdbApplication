...
import tw.practice.mywebdbapplication.service.OrderService;

import java.sql.ResultSet;
import java.sql.SQLException;
@Controller
public class OrderController {
    @Autowired   //自動連接Spring容器中的相關組件，這裡是將OrderService自動注入到OrderController中。
    OrderService orderService;

    @GetMapping("/order_all") //映射HTTP GET請求到對應的方法。
